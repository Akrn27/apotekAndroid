...
public class DBHelper extends SQLiteOpenHelper {
    ...
    public static final String row_nd = "ND";
    public static final String row_namaObat = "NamaObat";
    public static final String row_tglObat = "Tanggal";
    ...
    public void onCreate(SQLiteDatabase db){
        String query = "CREATE TABLE " + table_name + "(" + row_id + " INTEGER PRIMARY KEY AUTOINCREMENT,"
                + row_nomor + " TEXT, " + row_nama + " TEXT, " + row_nd + " TEXT, "
                + row_namaObat + " TEXT, " + row_tglObat + " TEXT, " + row_alamat + " TEXT)";
        db.execSQL(query);
    }
